...
//         localStorage.setItem('jwt_token', data.token); // store JWT for further use
//         }else{
//           setErrorMsg('Login failed: Token missing');
//         }
        
//         // Navigate or reload as per your app
//       } else {
...
//       } catch (jsonErr) {
//         // if error parsing, keep default message
//       }
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/compare" element={<CompareResult />} />
        <Route path="/" element={<HomePage />} />  {/* Always render HomePage */}
        <Route path="/login" element={<LoginPage />} />
        <Route path="*" element={<Navigate to="/" />} /> {/* Redirect unknown to home */}
      </Routes>
    </Router>
  );
}
